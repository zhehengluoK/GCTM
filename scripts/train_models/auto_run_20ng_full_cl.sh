...
do
  ...
  do
    ...
    do
      ...
      python run_scholar.py data/20ng/processed/ data/20ng/graph -k 50 --seed $seed -l $lr --epochs $epoch --device 3 --test-prefix test --o ./outputs/myModel_journal/20ng_full_cl/50_${seed}_${lr}_${epoch}_GCN --model GCNContrastiveScholar --bg-freq tfidf --dist 0
